...
Form::ExecuteException::ExecuteException(const std::string &nStr)
: str(nStr)
{ }

const char  *Form::ExecuteException::what(void) const throw()
{
    return str.c_str();
}

Form::ExecuteException::~ExecuteException(void) throw()
{ }
